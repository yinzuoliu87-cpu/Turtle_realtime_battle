...
for t in verify_dot_stacks verify_fonts verify_candy_jar verify_settings \
         verify_menu verify_codex verify_codex_text verify_pirate_hook verify_cyber_charge verify_sprite_sheets verify_skill_energy verify_hiding_pool verify_crystal_death_sync verify_season_flow verify_battle_ui verify_ghost_seed; do
  run_test "$t"
done
