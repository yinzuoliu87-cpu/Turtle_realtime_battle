...
FATAL='SCRIPT ERROR|Parse Error|Max recursion|freed instance|null instance|Cannot call|Invalid (get|set|call|index)|Trying to (assign|call)|Nonexistent'
...
for t in verify_dot_stacks verify_fonts verify_candy_jar verify_settings \
         verify_menu verify_codex verify_codex_text verify_pirate_hook verify_cyber_charge verify_sprite_sheets; do
  run_test "$t"
done
