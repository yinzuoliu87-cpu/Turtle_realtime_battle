...
func _test_no_plain_left() -> void:
	var src := FileAccess.get_file_as_string(TEAM_SRC) + "\n" + FileAccess.get_file_as_string("res://scripts/scenes/team_select/skill_picker.gd") + "\n" + FileAccess.get_file_as_string("res://scripts/scenes/team_select/detail_panel.gd")   # 技能选择器+详情面板(含render_bbcode)已抽出(2026-07-25/26)
