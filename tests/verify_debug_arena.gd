...
func _ready() -> void:
	...
	scene._debug._edit_set_brush(scene.TRAINER_ID)
	var tr = scene._debug._edit_place_unit(scene.TRAINER_ID, "left", Vector2(120, 120))
