...
const STATS := {
	...
	"p2eq_007": [{"atk": 5, "hp": 60}, {"atk": 10, "hp": 135}, {"atk": 20, "hp": 300}],
	...
	"p2eq_010": [{"atk": 30, "armorPen": 10, "hp": 150}, {"atk": 75, "armorPen": 18, "hp": 360}, {"atk": 200, "armorPen": 30, "hp": 3900}],
	# ── 剑系 011 (饮血护符坠) ──
	...
	# ── 盾系 012-017 ──
	"p2eq_012": [{"hp": 120, "def": 5}, {"hp": 210, "def": 10}, {"hp": 300, "def": 18}],
	"p2eq_013": [{"hp": 180, "reflectPct": 8}, {"hp": 330, "reflectPct": 11}, {"hp": 600, "reflectPct": 15}],
	"p2eq_014": [{"hp": 240, "def": 14, "mr": 14}, {"hp": 480, "def": 25, "mr": 25}, {"hp": 1800, "def": 50, "mr": 50}],
	"p2eq_015": [{"hp": 150, "reflectPct": 10}, {"hp": 240, "reflectPct": 17}, {"hp": 390, "reflectPct": 25}],
	"p2eq_016": [{"def": 6, "mr": 6}, {"def": 13, "mr": 13}, {"def": 21, "mr": 21}],
	"p2eq_017": [{"hp": 450, "def": 15, "mr": 15}, {"hp": 750, "def": 35, "mr": 35}, {"hp": 12000, "def": 150, "mr": 150}],
	# ── 盾系 018-021 (批3) ──
	...
	"p2eq_028": [{"hp": 90, "magicPen": 5}, {"hp": 120, "magicPen": 9}, {"hp": 180, "magicPen": 14}],
	"p2eq_029": [{"hp": 150, "def": 9}, {"hp": 330, "def": 15}, {"hp": 450, "def": 25}],
	# ── 潮汐系 041/042/044/047 + 枪械 055/058 (批6) ──
	"p2eq_041": [{"hp": 120, "shieldHealPct": 10}, {"hp": 270, "shieldHealPct": 15}, {"hp": 510, "shieldHealPct": 20}],
	"p2eq_042": [{"hp": 180, "shieldHealPct": 20}, {"hp": 300, "shieldHealPct": 25}, {"hp": 540, "shieldHealPct": 30}],
	"p2eq_044": [{"hp": 120, "def": 5}, {"hp": 180, "def": 12}, {"hp": 270, "def": 20}],
	"p2eq_047": [{"hp": 300}, {"hp": 600}, {"hp": 2100}],
	...
	"p2eq_037": [{"atk": 10, "hp": 240}, {"atk": 25, "hp": 390}, {"atk": 40, "hp": 540}],
	"p2eq_038": [{"hp": 240}, {"hp": 420}, {"hp": 600}],
	"p2eq_040": [{"hp": 300}, {"hp": 600}, {"hp": 1500}],
	"p2eq_045": [{"hp": 270, "def": 4, "mr": 4}, {"hp": 510, "def": 8, "mr": 8}, {"hp": 900, "def": 15, "mr": 15}],
	...
	"p2eq_059": [{"_maxEnergy": 110, "hp": 300}, {"_maxEnergy": 250, "hp": 630}, {"_maxEnergy": 1000, "hp": 3000}],
	# ── 杖系026雷电/027电棍/030·031水晶球 + 潮汐043海浪护符 (批10) ──
	"p2eq_026": [{"magicPen": 8}, {"magicPen": 13}, {"magicPen": 20}],
	"p2eq_027": [{"hp": 60, "def": 5, "mr": 5}, {"hp": 120, "def": 8, "mr": 8}, {"hp": 240, "def": 13, "mr": 13}],
	"p2eq_030": [{"atk": 7, "hp": 60, "magicPen": 5}, {"atk": 12, "hp": 120, "magicPen": 8}, {"atk": 20, "hp": 240, "magicPen": 13}],
	"p2eq_031": [{"atk": 7, "hp": 60, "magicPen": 3}, {"atk": 12, "hp": 120, "magicPen": 6}, {"atk": 20, "hp": 240, "magicPen": 10}],
	"p2eq_043": [{"hp": 240, "shieldHealPct": 10}, {"hp": 600, "shieldHealPct": 20}, {"hp": 15000, "shieldHealPct": 30}],
	# ── 召唤034玩偶小熊 (批12, 召唤大熊fighter — spawn管线在BattleScene) ──
	"p2eq_034": [{"atk": 20, "hp": 360}, {"atk": 50, "hp": 750}, {"atk": 300, "hp": 3000}],
	# ── 召唤039竹制弓箭 + 枪械052左轮 (批11) ──
	"p2eq_039": [{"hp": 240}, {"hp": 420}, {"hp": 600}],
	"p2eq_052": [{"atk": 40, "armorPen": 15}, {"atk": 90, "armorPen": 24}, {"atk": 500, "armorPen": 50}],
	# ── 召唤035黄铜齿轮 (批12, 死亡钩子) ──
	"p2eq_035": [{"hp": 300, "atk": 5}, {"hp": 390, "atk": 13}, {"hp": 540, "atk": 22}],
	# ── 召唤036温泉蛋 (批13, 复用孵化进度) ──
	"p2eq_036": [{"hp": 210}, {"hp": 360}, {"hp": 540}],
	# ── 潮汐046幽灵墨鱼 (批14, 复用_roll_dodge) ──
	"p2eq_046": [{"hp": 240}, {"hp": 420}, {"hp": 1200}],
	# ── 枪械056飞镖 (批15, 复用_knockedUpThisTurn击飞靶子) ──
	"p2eq_056": [{"atk": 45}, {"atk": 90}, {"atk": 400}],
	# ── 召唤032唤灵骨符(纯属性) + 033复活海螺(复用e_conch死亡变虫) (批16) ──
	"p2eq_032": [{"hp": 150}, {"hp": 180}, {"hp": 210}],
	"p2eq_033": [{"hp": 300}, {"hp": 540}, {"hp": 1200}],
}
