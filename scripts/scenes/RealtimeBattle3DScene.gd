...
const PASSIVE_SKILL_TYPES := {"iceBurnImmune": true, "lavaEnhancedRage": true, "shellEnhanceAwaken": true}   # phoenixEnhancedRebirth 改被动+主动混合(spawn给强化涅槃+主动放加速), 故移出纯被动集进主动轮转
