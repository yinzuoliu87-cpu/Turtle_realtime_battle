...
func _build_page_buttons(page: String, is_transition: bool) -> void:
	...
	match page:
		"main":
			items = [["在线模式", func(): _show_page("online"), false], ["本地模式", func(): _show_page("local"), false], ["🛒 商店", func(): _go("Shop"), false], ["🎒 背包", func(): _go("Inventory"), false], ["设置", func(): _go("Settings"), false]]
		"online":
