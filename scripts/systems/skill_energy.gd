...
const SKILL_COST := {
	...
	# 数据驱动伤害
	"basicBarrage": 80.0, "basicChiWave": 100.0, "basicSlam": 120.0, "bambooLeaf": 90.0, "bambooSmack": 120.0, "bambooSpikes": 130.0, "angelEquality": 125.0,
	...
	"cyberDeploy": 135.0, "bubbleBind": 70.0, "hidingShrink": 100.0, "hidingBuffSummon": 80.0, "shellCopy": 130.0, "shellShadow": 130.0, "diceFate": 90.0,
}
