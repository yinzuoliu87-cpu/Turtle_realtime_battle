...
const SKILL_COST := {
	...
	# 签名招
	"bambooHeal": 110.0, "angelBless": 80.0, "angelAscend": 80.0, "stoneRockShield": 100.0, "rockShockwave": 80.0, "stoneTaunt": 120.0, "iceFrost": 100.0, "iceFreeze": 80.0, "commonTeamShield": 80.0,
