...
## ✅**2026-08-20 已修**: `venom_drone_vfx.gd` 那侧改成了 `const FOG_LIFE := VenomDroneSystem.FOG_LIFE`,
##   两侧从此同源, 不会再各自漂。(原来 VFX 侧写死 4.0, 而这侧 2026-08-13 加强到 6.0,
##   导致每团毒雾只上 4 秒的毒、最后 2 秒是空转的死团。)
##   `tools/twin_const_audit.py` 会盯着这类"同功能两侧同名常量取值打架", 已进门禁。
