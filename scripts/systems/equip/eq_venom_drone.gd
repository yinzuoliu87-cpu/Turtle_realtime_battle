...
##
## ③ **携带者阵亡 ⇒ 飞行物立刻消失, 但【已经留下的毒雾照常活满 4 秒】。**
...
## n 层剧毒缓速的魔抗倍率
static func vslow_mr_mult(n: int) -> float:
	return 1.0 - VSLOW_MR_PER * float(clampi(n, 0, VSLOW_CAP))
