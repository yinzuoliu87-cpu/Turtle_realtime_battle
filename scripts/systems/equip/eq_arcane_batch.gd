...
## ★减伤曲线走 `DamageMath` 那两个静态函数(单一事实源), 没有在这里抄第二份。
## ⚠ 但与 `_resolve_dmg` 的魔法分支**并非逐字一致**: 那边在 RealtimeBattle3DScene.gd:4344-4345
##   还有一条 `if magic and tgt.id == "crystal": base *= 0.8`(水晶共鸣额外 −20% 魔法),
