...
const TIER_DESCS := {
	...
	"食物": [
		"队伍每件装备为其携带者额外提供 +30 最大生命值(食物类装备双倍 +60) · 【成长】每 2.5 秒, 每件食物为其携带者永久 +8 最大生命值(无上限)",
	...
	"药水": [
		"每件药水额外提供 +5 最大龟能 · 【猎物】每 2.5 秒自动将敌方当前生命值最高的 1 名单位标记为猎物(龟蛋除外; 猎物死亡后下个周期重选); 全队对猎物造成的伤害 +15%",
	...
	"法器": [
		...
		"每件法器额外提供 +7 法术穿透 与 +6 最大龟能 · 法力条满 80 · 【灵泉】每 2.5 秒, 全队回复已损失生命的 5%",
		"每件法器额外提供 +11 法术穿透 与 +8 最大龟能 · 法力条满 60 · 【灵泉】8% · 【余韵】友军受到治疗时, 额外获得等于治疗量 30% 的护盾",
		"每件法器额外提供 +14 法术穿透 与 +10 最大龟能 · 法力条满 50 · 【灵泉】12% · 【余韵】50% · 【共鸣】每 7.5 秒引动一次共鸣: 全队每个友军回复 15% 最大生命值, 并净化 2 种减益(眩晕/减速/灼烧/中毒/诅咒, 按此顺序)",
	],
	"灵物": [
	...
	"遗物": [
		...
		"每件遗物额外提供 +5% 生命偷取 · 【生死界】>50% 时 +5% 攻击力(<50% 吸血翻倍) · 【远古之力】每 2.5 秒全队永久 +4 攻击力(本场累积, 上限 +150) · 【龟蛋加固】本方龟蛋 +500 最大生命值",
		"每件遗物额外提供 +8% 生命偷取 · 【生死界】>50% 时 +8% 攻击力(<50% 吸血翻倍) · 【远古之力】每 2.5 秒全队永久 +7 攻击力(上限 +250) · 【龟蛋加固】本方龟蛋 +900 最大生命值",
		"每件遗物额外提供 +10% 生命偷取 · 【生死界】>50% 时 +12% 攻击力(<50% 吸血翻倍) · 【远古之力】每 2.5 秒全队永久 +11 攻击力(上限 +350) · 【龟蛋加固】本方龟蛋 +1500 最大生命值 · 【觉醒】本路战斗开打满 20 秒后, 已累积的远古之力 +50%, 之后每 2.5 秒的累积翻倍",
	],
}
