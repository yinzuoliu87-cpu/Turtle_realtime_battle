...
const TIER_DESCS := {
	...
	"盾": [
		"每件盾额外提供 +5 护甲 · 【怒气】全队每个单位每累计受到 400 点伤害, 就对最近的敌人释放一次冲击波, 造成 4% 自身最大生命值的真实伤害, 并为自己获得等量护盾值",
		"每件盾额外提供 +13 护甲 · 【怒气】冲击波 6% · 【圣光】每 5 秒为携带者生成 50 × (1 + 0.4 × 携带者身上盾件数) 护盾",
		"每件盾额外提供 +22 护甲 · 【怒气】冲击波 8% · 【圣光】90 × (1 + 0.4 × 件数) · 【反击】护盾存在时, 受到的每段伤害对来源造成 3 × (1 + 0.5 × 件数) 点真实伤害 · 【收殓】敌方单位阵亡时, 为最近的携带盾者提供该单位 30% 最大生命值的护盾",
	],
	"药水": [
